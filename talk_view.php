...
//取得页码
            ...
            $a = new page();
            $page = $a->talk_page("count", null, null);
            if ($p > $page) {
                require './500.html';
            } else {
//取得分类结果并分页
                $new = $a->talk_page("limit", null, $p);
                ...
                <div class="container">
                    ...
                    if (!isset($new)) {
                        ...
                        foreach ($new as $v) : ?>
                            <div class="row">
                                <a id="newstitle1" href="Talk.php?id=<?php echo $v['id'] ?>" target="_blank">
                                    <div class="col-sm-6">
                        ...
                        <div style="text-align: center">
                            <ul class="pagination">
                                ...
                                <?php for ($i = 1; $i <= $page; $i++) { ?>
                                    <li>
                                        <a href="talk_view.php?sort_id=<?php echo $sid ?>&p=<?php echo $i ?>"><?php echo $i ?></a>
                                    </li>
                                <?php } ?>
                                <?php if ($p != $page) { ?>
                                    <li><a href="talk_view.php?sort_id=<?php echo $sid ?>&p=<?php echo $p + 1; ?>"><span
